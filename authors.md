...
- **Hugo Machado Rodrigues**. Author, maintainer, copyright holder.

## Citation

Source:
[`inst/CITATION`](https://github.com/HugoMachadoRodrigues/DroneBioR/blob/v0.5.1/inst/CITATION)

Rodrigues H (2026). *DroneBioR: Reproducible Drone Biomass Workflows for
Multispectral Imagery*. R package version 0.5.1,
