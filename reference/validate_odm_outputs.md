...
#> 5  /tmp/RtmpsVBnJn/outputs/odm_micasense_dataset/micasense/odm_georeferencing/odm_georeferenced_model.copc.laz
#> 6       /tmp/RtmpsVBnJn/outputs/odm_micasense_dataset/micasense/odm_georeferencing/odm_georeferenced_model.laz
#> 7       /tmp/RtmpsVBnJn/outputs/odm_micasense_dataset/micasense/odm_georeferencing/odm_georeferenced_model.las
#> 8                     /tmp/RtmpsVBnJn/outputs/odm_micasense_dataset/micasense/odm_filterpoints/point_cloud.ply
#> 9             /tmp/RtmpsVBnJn/outputs/odm_micasense_dataset/micasense/odm_texturing/odm_textured_model_geo.obj
#> 10            /tmp/RtmpsVBnJn/outputs/odm_micasense_dataset/micasense/odm_texturing/odm_textured_model_geo.glb
#> 11                               /tmp/RtmpsVBnJn/outputs/odm_micasense_dataset/micasense/3d_tiles/tileset.json
#> 12                               /tmp/RtmpsVBnJn/outputs/odm_micasense_dataset/micasense/odm_report/report.pdf
#>    exists size_mb dimensions extent_m  crs valid   notes
