...
- [`detect_odm_projects()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/detect_odm_projects.md)
...
- [`build_point_cloud_only()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/build_point_cloud_only.md)
  : Reconstruct up to the point cloud and stop
- [`default_max_concurrency()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/default_max_concurrency.md)
...
- [`refilter_odm_point_cloud()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/refilter_odm_point_cloud.md)
  : Re-clean an ODM point cloud without redoing the reconstruction
- [`rebuild_from_edited_cloud()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/rebuild_from_edited_cloud.md)
...
- [`pick_best_point_cloud()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/pick_best_point_cloud.md)
...
- [`webodm_list_projects()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/webodm_list_projects.md)
...
- [`webodm_task_status()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/webodm_task_status.md)
  : Poll the status of a WebODM task

- [`webodm_download_asset()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/webodm_download_asset.md)
  : Download an asset from a WebODM task

- [`run_webodm_project()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/run_webodm_project.md)
...
- [`detect_djim3m_ppk_files()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/detect_djim3m_ppk_files.md)
  : Detect DJI Mavic 3M PPK / RTK sidecar files

- [`inspect_djim3m_mrk()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/inspect_djim3m_mrk.md)
...
- [`parse_djim3m_mrk_folder()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/parse_djim3m_mrk_folder.md)
  : Parse and merge every .MRK in a folder

- [`write_djim3m_geo_txt()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/write_djim3m_geo_txt.md)
  :

  Write an ODM `geo.txt` from a .MRK folder + a list of filenames

- [`ppk_cli_rtklib_dji()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/ppk_cli_rtklib_dji.md)
  : PPK CLI hook factory using rtklib + a DJI .bin -\> RINEX converter

- [`detect_geoscan_metadata()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/detect_geoscan_metadata.md)
  : Detect GeoScan metadata sibling of a source-images folder

- [`read_geoscan_cameras()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/read_geoscan_cameras.md)
  : Read GeoScan-style camera position file

- [`read_geoscan_gnss_offset()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/read_geoscan_gnss_offset.md)
  : Read GeoScan GNSS-to-camera offset file

- [`convert_geoscan_to_odm_geo()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/convert_geoscan_to_odm_geo.md)
  :
...
- [`default_rgb_band_map()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/default_rgb_band_map.md)
...
- [`canonical_band_names()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/canonical_band_names.md)
  : Canonical band names from whatever a raster calls its layers

- [`default_band_map_for_layers()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/default_band_map_for_layers.md)
  :
...
- [`set_radiometric_level()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/set_radiometric_level.md)
  [`radiometric_level()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/set_radiometric_level.md)
...
- [`improve_dtm_csf()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/improve_dtm_csf.md)
...
- [`predict(`*`<dronebio_plate_meter>`*`)`](https://hugomachadorodrigues.github.io/DroneBioR/reference/predict.dronebio_plate_meter.md)
...
- [`predict_biomass_map()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/predict_biomass_map.md)
  : Predict a biomass map from a fitted model
- [`run_biomass_mapping()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/run_biomass_mapping.md)
...
- [`parse_ply_header()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/parse_ply_header.md)
...
- [`write_ply_subset()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/write_ply_subset.md)
  ...
  layout
- [`despike_point_cloud()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/despike_point_cloud.md)
  : Flag reconstruction spikes in a point cloud
- [`despike_ply()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/despike_ply.md)
...
- [`build_chm_raster()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/build_chm_raster.md)
...
- [`harmonize_dem_products()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/harmonize_dem_products.md)
...
- [`validate_odm_outputs()`](https://hugomachadorodrigues.github.io/DroneBioR/reference/validate_odm_outputs.md)
