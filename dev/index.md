...
**DroneBioR** is a research-oriented R package and web application
(Drone Biomass Studio) for drone biomass analysis with MicaSense
multispectral imagery. It delegates the heavy photogrammetry work (SfM,
MVS, mesh, texturing) to external engines — **OpenDroneMap**,
**WebODM**, **Pix4Dmapper** or **Agisoft Metashape** — and contributes
the scientific layer in R:
...
- **3D Modeling** — full-width WebGL viewport with OrbitControls, XYZ
  ...
  the currently-selected points, with six base-reference methods (Pix4D
  / ContextCapture / Trimble convention).
- **Spectral Analytics** — orthomosaic reading, radiometric scaling,
  panel calibration, the 9-index stack, application maps.
- **Field Models** — extract spectral values at field samples, fit a
  baseline biomass linear model.
- **Time Series** — register multiple flights of the same site and plot
  NDVI / biomass / CHM across dates.
- **Exports** —
  [`run_dronebio_workflow()`](https://hugomachadorodrigues.github.io/DroneBioR/dev/reference/run_dronebio_workflow.md)
  one-click; HTML report via
...
Drone Biomass Studio is a web application for previewing orthomosaics,
...
- [Overview](https://hugomachadorodrigues.github.io/DroneBioR/dev/vignettes/dronebior-overview.Rmd)
  — end-to-end pipeline.
- [External
  engines](https://hugomachadorodrigues.github.io/DroneBioR/dev/vignettes/external-engines.Rmd)
  — read products from ODM, WebODM, Pix4Dmapper and Agisoft Metashape.
- [Spectral
  indices](https://hugomachadorodrigues.github.io/DroneBioR/dev/vignettes/spectral-indices.Rmd)
  — index catalogue and recommended use per crop and canopy density.
- [Point clouds and
  CHM](https://hugomachadorodrigues.github.io/DroneBioR/dev/vignettes/point-clouds-and-chm.Rmd)
...
[CONTRIBUTING.md](https://hugomachadorodrigues.github.io/DroneBioR/dev/CONTRIBUTING.md)
and the [Code of
Conduct](https://hugomachadorodrigues.github.io/DroneBioR/dev/CODE_OF_CONDUCT.md)
...
in R or refer to
[`CITATION.cff`](https://hugomachadorodrigues.github.io/DroneBioR/dev/CITATION.cff).

## License

DroneBioR is released under the [GNU Affero General Public License
v3](https://hugomachadorodrigues.github.io/DroneBioR/dev/LICENSE.md).
